...
const project_list =
    [
      {
        ...
        'summary' :
            'React web application that helps users make informed decisions about where they want to relocate to',
        'bullets' : [
          'Solely responsible for building and designing the signup and login pages',
          'Collaborated with 7 team members on a cross functional team to complete project in 5-week deadline'
        ],
      },

      {
        ...
        'summary' :
            'React application built to help users organize contact information for all donors to their organization\'s campaigns',
        'bullets' : [
          'Solely responsible for developing the "about us" page, navigation, and header portion of the landing page',
          'Held the role of senior front-end developer and collaborated with teams members to build front end'
        ],
      },

      {
        ...
        'github' :
            'https://github.com/DV-Empathy-Builder/landing-page-merge-fix',
        'stack' : [ 'Html', 'CSS', 'JavaScript', 'Node.js' ],
        'link' : 'https://dv-empathy-builder.github.io/landing-page-merge-fix/',
        'summary' :
            'Helps web page visitors build empathy for victims of domestic violence by calculating the cost to relocate',
        'bullets' : [
          'Solely responsible for constructing the navigation and about us page',
          'Collaborated with team members to build landing pages for project'
        ],
      }
    ]
    ...
    function createNewProject(project) {
      ...
      // const aosCenter =
      // document.createAttribute('data-aos-anchor-placement'); const
      // aosDuration = document.createAttribute('data-aos-duration');
      ...
      title_container.insertAdjacentHTML(
          'beforeend',
          `<a href=${project.github}><i class="fab fa-github-square"></i></a>`)
      ...
      project.stack.forEach(
          skill => stack_container.insertAdjacentHTML(
              'beforeend', `<i  class="${skills_list[skill]}"></i>`));
    ...
    project_list.forEach(
        project => projects_section.appendChild(createNewProject(project)));